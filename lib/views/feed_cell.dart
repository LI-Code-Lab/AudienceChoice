        ...
        child: new Column(
          ...
          children: <Widget>[
            new Container(
                ...
                child: new Text("Title: " + title, style: new TextStyle(fontSize: 20.0, color: kACPrimaryText, fontWeight: FontWeight.bold))),
            new Container(
                margin: new EdgeInsets.fromLTRB(0.0, 0.0, 0.0, 8.0),
                child: new Text("Artist: " + artist, style: new TextStyle(fontSize: 20.0, color: kACPrimaryText, fontWeight: FontWeight.bold))),
